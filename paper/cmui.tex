...
%=================================================================
\documentclass[geomatics,article,submit,moreauthors]{Definitions/mdpi} 
...
\newcommand{\orcidauthorA}{0000-0001-6717-2200}  % Sharon Christa
\newcommand{\orcidauthorB}{0009-0007-3591-5373}  % Rekha Jayaram
\newcommand{\orcidauthorC}{0009-0001-1894-7783}  % Riya Sharma
%\newcommand{\orcidauthorB}{0000-0000-0000-000X} % Add \orcidB{} behind the author's name

\Author{Sharon Christa $^{1,}$*\orcidA{},
        Rekha Jayaram $^{2}$\orcidB{} and
        Riya Sharma $^{3}$\orcidC{}}
 
% AuthorNames — for PDF metadata
\AuthorNames{Sharon Christa, Rekha Jayaram and Riya Sharma}
 
% Affiliations
\address{%
$^{1}$ \quad Department of Computer Science and Engineering,
            School of Computing,
            MIT Art, Design and Technology University,
            Pune 412201, India;
            sharonchrista@gmail.com\\
$^{2}$ \quad Department of Information Science and Engineering,
            Dayananda Sagar College of Engineering,
            Bengaluru 560078, India;
            rekhajayaram20@gmail.com\\
$^{3}$ \quad Department of Commerce,
            Graphic Era Deemed to be University,
            Dehradun 248002, India;
            riyasharma6568@gmail.com}
 
% Corresponding author
\corres{Correspondence: sharonchrista@gmail.com}
 
% Optional notes
\firstnote{Associate Professor, School of Computing,
           MIT Art, Design and Technology University.}
